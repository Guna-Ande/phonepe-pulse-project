#clone data from pulse repository to local via git
#git bash cd \pathtogetdataclonedto
#git clone https://github.com/phonepe/pulse.git
#after cloning we should make appropriate databases to retrieve cloned data
#necessary packages
...
#we now created tables as of above...now we use streamlit to project our findings using plotly..
import json
import streamlit as st
import pandas as pd
import requests
...
with tab1:
    ...
    with col1:
        image = Image.open("C:\\Users\\91832\\Desktop\\phonepe\\PhonePe-Logo.wine.png")
        st.image(image)
